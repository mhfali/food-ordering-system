...
if(empty($_SESSION["user_id"]))
{
	header('location:login.php');
												...
												$item_total += ($item["price"]*$item["quantity"]);
													...
													$SQL="insert into users_orders(u_id,title,quantity,price,d_id) values('".$_SESSION["user_id"]."','".$item["title"]."','".$item["quantity"]."','".$item["price"]."','".$item["d_id"]."')";
                                                    
						
														mysqli_query($db,$SQL);
                                                        $mql = "update users set address='".$_POST['address']."' where u_id='$_SESSION[user_id]' ";
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="payment-option">
                                       ...
                                       <textarea class="form-control" id="exampleTextarea"  name="address" rows="3" require></textarea>
                                    </div>
